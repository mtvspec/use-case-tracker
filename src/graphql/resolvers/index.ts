...
const resolvers = {
  ...
  RolesConnection: UsersResolvers.queries.RolesConnection,
  UserRolesConnection: UsersResolvers.queries.UserRolesConnection,
  UserRoleEdge: UsersResolvers.queries.UserRoleEdge,
