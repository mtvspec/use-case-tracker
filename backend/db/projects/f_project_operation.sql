...
CREATE FUNCTION projects.start_project (
  ...
  IN v_e_project_team_id INTEGER DEFAULT NULL,
  ...
  IN v_a_fact_start_date DATE DEFAULT NULL,
...
WITH upd AS (
  ...
  SET
    ...
    a_project_description = v_a_project_description,
...
VALUES (
  ...
  (SELECT a_project_description FROM upd),
...
SELECT
  projects.start_project (
    ...
    v_a_project_description := 'Use case tracker...',
